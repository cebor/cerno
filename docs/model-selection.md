...
| Model | Fidelity | Accuracy | noul | choice | score | p50 | p99 | Truncated | Brier | Best T | Agreement |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `gemma4:26b-a4b-it-q4_K_M` *(reference)* | 100% | 97% | 93% | 100% | 100% | 131 ms | 403 ms | 39% | 0.029 | 3.20 | — |
| `gemma4:e2b-it-qat` | 100% | 97% | 100% | 92% | 100% | 35 ms | 41 ms | 0% | 0.006 | 0.80 | 89% |
| `granite4:3b` | 100% | 81% | 79% | 83% | 80% | 22 ms | 33 ms | 0% | 0.167 | 2.10 | 75% |
| `phi4-mini:3.8b` | 100% | 86% | 93% | 92% | 70% | 24 ms | 31 ms | 0% | 0.023 | 2.25 | 75% |
